...
public class DBservices
{
    ...
    //--------------------------------------------------------------------------------------------------
    public int setActiveDB(string email, bool isActive)
    {
        ...
        cmd = CreateCommandWithStoredProcedureUpdateUserActivity("spUpdateUserActivity", con, email, isActive);             // create the command
    ...
    // Create the SqlCommand using a stored procedure to UPDATE VACATION  
    private SqlCommand CreateCommandWithStoredProcedureUpdateUserActivity(String spName, SqlConnection con, string email, bool isActive)
    {
